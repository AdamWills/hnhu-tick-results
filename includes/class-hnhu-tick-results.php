 ...
 * @subpackage Hnhu_Tick_Results/includes
 */
...
class Hnhu_Tick_Results {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Hnhu_Tick_Results_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name = 'hnhu-tick-results';
		$this->version = '1.0.0';
	 ...
	 *
	 * - Hnhu_Tick_Results_Loader. Orchestrates the hooks of the plugin.
	 * - Hnhu_Tick_Results_i18n. Defines internationalization functionality.
	 * - Hnhu_Tick_Results_Admin. Defines all hooks for the admin area.
	 * - Hnhu_Tick_Results_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-hnhu-tick-results-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-hnhu-tick-results-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-hnhu-tick-results-admin.php';
	 ...
	 *
	 * Uses the Hnhu_Tick_Results_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Hnhu_Tick_Results_i18n();
	 ...
	 *
	 * @since     1.0.0
	 * @return    Hnhu_Tick_Results_Loader    Orchestrates the hooks of the plugin.
	 */
